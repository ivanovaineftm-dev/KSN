...
- Обработка файла по правилам:
  1. Удаляются строки, где столбец **C** содержит одну из ролей: `бариста`, `кассир`, `повар`, `повар-универсал`, `практикант`, `работник торгового зала`, `уборщик`, `директор`, `старший кассир`.
