...
- Обработка файла по правилам:
  ...
  4. Строка выделяется бледно-красным, если столбец **H** пустой.
  5. Строка выделяется бледно-красным, если столбец **F** (должность наставника) пустой.
  6. Строка выделяется бледно-красным, если для `повар-стажер` в столбце **C** наставник в столбце **F** не равен `повар-универсал` или `повар`.
