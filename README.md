...
- Обработка файла по правилам:
  1. Удаляются строки, где столбец **G** пустой.
  2. Удаляются строки, где столбец **G** содержит `февраль` (любой регистр, также с подстрокой `феврал`).
  3. Удаляются строки, где столбец **H** пустой.
